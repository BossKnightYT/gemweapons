...
public class TimeThingItem extends Item {

    private static final int COOLDOWN_TICKS = 6000; // 5 minute cooldown

    public TimeThingItem(Settings settings) {
        super(settings.maxCount(1));
    }
    @Override
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        tooltip.add(Text.translatable("tooltip.gemweapons.the_hourglass").formatted(Formatting.AQUA));
